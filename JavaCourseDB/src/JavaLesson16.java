...
public class JavaLesson16 {
	...
	public static void main(String[] args) {
		...
		// superCar inhertits all of the Object methods,
		// but an Object can't access the Vehicle methods
		...
		// toString is often used to convert primitives to string
		...
		// them to another. If changes are made often the clone both
		...
		/*
		 * There are subobjects defined in an object clone won't also clone them.
		 * You'd have to do that manually, but this topic will be covered
		 * in the future because of complexity.
		 */
