/*
 * In the last tutorial I coordinated threads using a timing method.
 * Here I show you how to execute code based on a predefined time schedule and much more
 */
...
public class JavaLesson18 {
	...
	public static void addThreadsToPool() {
		...
		// Allows you do schedule code execution at some time in the future
		...
		// Get priority of all the threads (Priority is equal to the thread that created the new thread.
