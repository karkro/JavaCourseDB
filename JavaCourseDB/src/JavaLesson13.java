 ...
 * A String class is an object unlike the other primitive data types
 */
...
public class JavaLesson13 {
	...
	public static void main(String[] args) {
		...
		// Returns a positive number if letter comes after moreLetters
		// There is also compareToIgnoreCase()
		System.out.println(letters.compareToIgnoreCase(moreLetters));
		
		// contains() returns a boolean depending on whether the String
		// contains the String you pass it
		...
		// You define how to break up the String using d delimiter
		...
		// delete() removes part of SB from first index to the last
		System.out.println(randSB.delete(15, 21));
		
		// deleteCharAt(index) is used to delete individual chars
		
		// capacity() returns the number of indexes for the SB
		...
		// insert() inserts a SB into a String
