...
public class JavaLesson03 {
	...
	public static void main(String[] args) {
		...
		// If randomNumber  wasn't less than 25, then check if it's greater than it.
		// If so, execute the code between {} and then stop checking.
		else if (randomNumber > 25) {
			System.out.println("The random number is greater than 25.");
		}
		
		// Check if randomNumber equal 25
		else if (randomNumber == 25) {
			System.out.println("The random number is equal to 25.");
		}
		
		// Check if randomNumber is not equal to 15
		else if (randomNumber != 15) {
			System.out.println("The random number is not equal to 15.");
		}
		
		// Check if randomNumber is less than or equal to 25
		else if (randomNumber <= 25) {
			System.out.println("The random number is less than or equal to 25.");
		}
		
		// Check if randomNumber is greater than or equal to 25
		else if (randomNumber >= 25) {
		...
		case 'b': // You can use multiple case statement in a row
		case 'B':
