...
public class JavaLesson22 extends JFrame {
	...
	public JavaLesson22() {
		...
		// You do this so that when 1 is selected the others are deselected
		...
		// createLoweredBorder, createRaisedBevelBorder
		...
		// Select the add radio button by default
		...
		// Create an instance of ListenerForEvents to handle events
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				try {
					...
					// JOptionPane displays a pop-up on the screen
					...
					System.exit(0); // Close the Java app
				}
				...
				// STAROPOLSKA IZBA PRZEMYS£OWO - HANDLOWA - DOFINANSOWANIE KURSÓW
			}
		}
	}
