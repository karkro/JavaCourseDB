...
public class JavaLesson29 extends JFrame {
	...
	public JavaLesson29() {
		...
		this.setTitle("Calculator ver. 1.0");
		...
		// Defines where to place components if they don't fill the space: CENTER, NORTH, SOUTH, EAST, WEST, NORTHEAST ...
		gridConstraints.anchor = GridBagConstraints.CENTER;
		
		// How should the component be stretched to fill the space: NONE, HORIZONTAL, VERTICAL, BOTH
		gridConstraints.fill = GridBagConstraints.BOTH;
		
		textResult = new JTextField("0", 2);
