...
public class JavaLesson19 {
	...
	public static void main(String[] args) {
		...
		String longString = "karkro, Poland, Kielce, Miastko scyzoryków";
		String strangeString = "   12 xxxx sd ???? %%% {{{ ]]]   ";
		
		/*
		 * [ ] Insert characters that are valid
		 * [* ] Insert characters that are not valid
		 * \\s Any white space
		 * \\S Any not white space
		...
		regexChecker("\\s[A-Za-z]{2,10}\\s", longString);
	...
	public static void regexChecker(String theRegex, String str2Check) {
		...
		// Cycle though the positive matches and print them to screen
	...
	public static void regexReplace(String str2Replace) {
		...
		// trim to string t prepare it for a replace
