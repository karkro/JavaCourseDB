...
public class JavaLesson21 extends JFrame {
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				// e.getSource().toString() returns informations on the button and the event that occured
			}
		}
	}
	...
	private class ListenForWindow implements WindowListener {
		...
		// Called when the window goes from normal to minimized state
		public void windowIconified(WindowEvent e) {
			textArea1.append("Window is minimized\n");
			
		}

		// Called when the window is first time created
